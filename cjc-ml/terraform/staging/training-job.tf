resource "databricks_job" "model_training_job" {
  name = "${local.env_prefix}cjc-ml-model-training-job"
  ...
  task {
    ...
    notebook_task {
      notebook_path = "cjc-ml/training/notebooks/TrainWithFeatureStore"
      base_parameters = {
        ...
        model_name         = "${local.env_prefix}cjc-ml-model"
      }
    }
  ...
  task {
    ...
    notebook_task {
      notebook_path = "cjc-ml/validation/notebooks/ModelValidation"
      base_parameters = {
        env             = local.env
        experiment_name = databricks_mlflow_experiment.experiment.name
  ...
  task {
    ...
    notebook_task {
      notebook_path = "cjc-ml/deployment/model_deployment/notebooks/TriggerModelDeploy"
      base_parameters = {
        env = local.env
      }
    }
