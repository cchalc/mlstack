...
# It is configured and can be executed as a training-job.tf job defined under ``cjc-ml/terraform``
#
# Parameters:
#
...
dbutils.widgets.text(
    "experiment_name",
    "/cjc-ml/cjc-ml-experiment-test",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode..
dbutils.widgets.text(
    "model_name", "cjc-ml-model-test", label="Model Name"
)
