...
[ML Config](../cjc-ml/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts cjc-ml/terraform/README.md
...
We recommend including all files outside of `cjc-ml/terraform` in this PR:
...
Follow the instructions in [cjc-ml/terraform/README.md](../cjc-ml/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../cjc-ml/terraform/README.md) to propose, test, and deploy
