resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "cjc-ml-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "cjc-ml-cicd"
  project_directory_path       = "/cjc-ml"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "cjc-ml-service-principals"
}
